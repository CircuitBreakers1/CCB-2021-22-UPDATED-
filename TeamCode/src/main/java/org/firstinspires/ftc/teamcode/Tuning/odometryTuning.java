...
import static org.firstinspires.ftc.teamcode.Subsystems.Robot2023.ticksPerRev;
import static org.firstinspires.ftc.teamcode.Subsystems.Robot2023.wheelRadius;
...
public class odometryTuning extends LinearOpMode {
    ...
    final double COUNTS_PER_INCH = 1440 / (2 * 3.1415 * wheelRadius);
    ...
    public void runOpMode() throws InterruptedException {
       ...
       */
        ...
        double k = (2 * PI * wheelRadius) / 1440;

        double leftRadius = k * verticalLeft.getCurrentPosition() / Math.toRadians(angle);
        double rightRadius = k * verticalRight.getCurrentPosition() / Math.toRadians(angle);
        double backRadius = k * horizontal.getCurrentPosition() / Math.toRadians(angle);
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData("Left Radius", leftRadius);
            telemetry.addData("Right Radius", rightRadius);

            telemetry.addData("Wizard \"Values\"", "");
