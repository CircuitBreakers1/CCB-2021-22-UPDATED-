...
import static org.firstinspires.ftc.teamcode.Subsystems.Robot.cameraInit.APRIL_SLEEVE;
import static org.firstinspires.ftc.teamcode.Subsystems.Robot.cameraInit.COLOR_SLEEVE;
import static org.firstinspires.ftc.teamcode.Subsystems.Robot.cameraInit.CONE_STACK;
...
public class Robot {
    ...
    public static ApriltagSleevePipeline apriltagSleevePipeline =
            new ApriltagSleevePipeline(0.177, 578.272, 578.272, 402.145, 221.506);
...
//        rightBack = new MotorEx(hwMap, "rightBack", Motor.GoBILDA.RPM_312);
    ...
    public enum cameraInit {
        NO_CAM, COLOR_SLEEVE, APRIL_SLEEVE, TWO_CAM_JUNCTION, CONE_STACK
    }
